...
# MINDAY 0.010 Tokyo
# daisy.coffee
# Процедуры для работы с ромашками
################################################

#=============================
# 1. ОСНОВНЫЕ ПАРАМЕТРЫ 
#=============================
canvastype[DAISY] =-> ACTIVE # Активная канва, то есть размер задается рисунком

childkind[DAISY] =-> PETAL
childsd[DAISY] =-> OUTSIDE
childkind[PETAL] =-> PETAL
childsd[PETAL] =-> OUTSIDE
