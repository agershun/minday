...
sample.start = function() {
  var m, md, md1, md11, md12, md14, md2, md21, md211, md22, md221, md3, md4;
  ...
  md3 = md.add("Инструменты анализа", {
    valign: TOP
  });
  ...
  md21.add({
    kind: IMAGE,
    url: "icon-swot-64-64.png",
    w: 64,
    h: 64
  });
  md211 = md21.adr("SWOT-анализ", {
    goto: sample.swot()
  });
  md211.add("Анализ сильных<br>и слабых сторон", {
    plain: true
  });
  md22 = md2.adr({
    intype: TABLE,
  ...
  md22.add({
    kind: IMAGE,
    url: "icon-businessmodel-64-64.png",
    w: 64,
    h: 64
  });
  md221 = md22.adr("Бизнес-модель");
  md221.add("Описание стратегии<br>предприятия", {
    plain: true
  });
  return md;
  /*
