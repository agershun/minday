...
Idea.prototype.kindTabs = function() {
  ...
  if (!(this.activetab != null) && (((_ref1 = this[0]) != null ? _ref1[0] : void 0) != null)) {
    return this.activetab = 0;
  }
};

draw[TABS] = function(level) {
  var i, ia, s, _i, _j, _len, _len1, _ref, _ref1;
  if (this.ativetab == null) {
    this.activetab = 0;
  }
  tbs.push(this);
  s = this.startIdeaTxt(level, DRAWHEADER);
