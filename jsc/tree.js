...
canvastype[TREE] = function() {
  return ACTIVE;
};

childkind[TREE] = function() {
  return NODE;
};

childsd[TREE] = function() {
  return OUTSIDE;
};
...
Idea.prototype.kindTree = function() {
  return this.kind = TREE;
};

Idea.prototype.kindNode = function() {
  return this.kind = NODE;
};

ssshape[NODE] = function(x, y, w, h) {
  var frm;
